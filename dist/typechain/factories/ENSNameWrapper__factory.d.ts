...
import type { ENSNameWrapper, ENSNameWrapperInterface } from "../ENSNameWrapper";
export declare class ENSNameWrapper__factory {
    ...
    static createInterface(): ENSNameWrapperInterface;
    static connect(address: string, runner?: ContractRunner | null): ENSNameWrapper;
}
