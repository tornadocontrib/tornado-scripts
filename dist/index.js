...
class TornadoNetInfo extends NetInfo {
  ...
  constructor(netInfo, netInfoRevision, rpcInfos, tokenInfos, instanceInfos) {
    ...
    this.stablecoin = netInfo.stablecoin || ethers.ZeroAddress;
  ...
  toJSON() {
    return {
      ...
      stablecoin: this.stablecoin !== ethers.ZeroAddress ? this.stablecoin : void 0,
  ...
  get tokens() {
    return this.instanceInfos.reduce(
      (acc, { address: instanceAddress, denomination, tokenAddress, instanceApproval, isOptional, isDisabled }) => {
        ...
        const amount = Number(ethers.formatUnits(denomination, decimals)).toFixed(0);
        if (isDisabled) {
          return acc;
        }
        if (!acc[symbolKey]) {
  ...
  getInstances(currency) {
    ...
    return instances.map((i) => ({
      ...
      symbol,
      decimals,
      amount: Number(ethers.formatUnits(i.denomination, decimals)).toFixed(0),
      transferGas
    }));
  }
  ...
  getInstanceByAddress(instanceAddress) {
    ...
    return {
      ...
      symbol,
      decimals,
      amount: Number(ethers.formatUnits(instanceInfo.denomination, decimals)).toFixed(0),
      transferGas
    };
  }
}
...
exports.INFO_REGISTRY_ADDRESS = INFO_REGISTRY_ADDRESS;
exports.INFO_REVISION = INFO_REVISION;
...
exports.MULTILOCK_ADDRESS = MULTILOCK_ADDRESS;
...
exports.TORNADO_PROXY_LIGHT_ADDRESS = TORNADO_PROXY_LIGHT_ADDRESS;
exports.TOVARISH_REGISTRY_ADDRESS = TOVARISH_REGISTRY_ADDRESS;
...
exports.TornadoInfos = TornadoInfos;
exports.TornadoNetInfo = TornadoNetInfo;
...
exports.getNetInfoSchema = getNetInfoSchema;
...
exports.netInfoSchemaV0 = netInfoSchemaV0;
...
exports.rHex = rHex;
exports.relayerRegistryEventsSchema = relayerRegistryEventsSchema;
