...
class TornadoWallet extends ethers.Wallet {
  ...
  static fromMnemonic(mneomnic, provider, index = 0, options) {
    ...
    const { privateKey } = ethers.HDNodeWallet.fromPhrase(mneomnic, undefined, defaultPath);
...
exports.ONEINCH_ORACLE_ADDRESS = ONEINCH_ORACLE_ADDRESS;
...
exports.TOVARISH_AGGREGATOR_ADDRESS = TOVARISH_AGGREGATOR_ADDRESS;
...
exports.TornadoConfig = TornadoConfig;
