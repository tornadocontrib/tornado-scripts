...
export interface ENSNameWrapper extends BaseContract {
  ...
  extendExpiry: TypedContractMethod<
    [parentNode: BytesLike, labelhash: BytesLike, expiry: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  "isWrapped(bytes32,bytes32)": TypedContractMethod<
    [parentNode: BytesLike, labelhash: BytesLike],
    [boolean],
    "view"
  >;
  ...
  unwrap: TypedContractMethod<
    [parentNode: BytesLike, labelhash: BytesLike, controller: AddressLike],
    [void],
    "nonpayable"
  >;

  unwrapETH2LD: TypedContractMethod<
    [labelhash: BytesLike, registrant: AddressLike, controller: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "canExtendSubnames"
  ): TypedContractMethod<
    [node: BytesLike, addr: AddressLike],
    [boolean],
    "view"
