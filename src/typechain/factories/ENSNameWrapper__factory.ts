...
export class ENSNameWrapper__factory {
  static readonly abi = _abi;
  static createInterface(): ENSNameWrapperInterface {
    return new Interface(_abi) as ENSNameWrapperInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ENSNameWrapper {
    return new Contract(address, _abi, runner) as unknown as ENSNameWrapper;
  }
}
